    ...
    try {
      ...
      const response = await fetch('/api/upload-image', {
        ...
        body: JSON.stringify({
          ...
          price: (tags.price && tags.price.toString().trim() !== '') ? (isNaN(parseFloat(tags.price)) ? null : parseFloat(tags.price)) : null
        })
      });
    ...
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-purple-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">What would you like to sell today?</h1>
          <p className="text-gray-600">Receive predictions for competitive pricing</p>
        </div>
            ...
            <div className="space-y-6">
              ...
              {tags && (
                <div className="bg-linear-to-br from-indigo-50 to-purple-50 rounded-xl p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setTags({...tags, main_category: e.target.value})}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-semibold text-gray-600">Price (USD)</label>
                      <input
                        type="number"
                        step="0.01"
                        value={tags.price}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setTags({...tags, pickup_location: e.target.value})}
                        className="w-full mt-1 px-3 py-2 border border-indigo-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
